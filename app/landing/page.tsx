    ...
    <section className="hero">
      ...
      <div className="hero-grid">
        ...
        <div className="product-stage" aria-label="Interactive product preview">
          ...
          <div className="floating-card left"><b>内容表现 · 示意</b><span>优质短视频带来更多自然流量</span><strong>+62%</strong></div>
          <div className="floating-card right"><b>投放效果 · 示意</b><span>单次获客成本出现波动</span><strong className="danger">+28%</strong></div>
        </div>
      </div>
    </section>
